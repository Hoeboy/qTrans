#ifndef DIALOGCOORDINATEDIRECTSOLUTION_H
#define DIALOGCOORDINATEDIRECTSOLUTION_H
...
namespace Ui {
class DialogCoordinateDirectsolution;
}

class DialogCoordinateDirectsolution : public QDialog
{
    Q_OBJECT

public:
    explicit DialogCoordinateDirectsolution(QWidget *parent = nullptr);
...
private:
    Ui::DialogCoordinateDirectsolution *ui;
    Projection prj_bj54;
...
#endif // DIALOGCOORDINATEDIRECTSOLUTION_H
